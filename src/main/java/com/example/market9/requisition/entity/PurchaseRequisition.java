...
import com.example.market9.board.entity.TimeStamp;
...
@Getter
@NoArgsConstructor
public class PurchaseRequisition extends TimeStamp {
    @Id
...
//  private String sellerName; //회원 가입시 적는 아이디  중복 X ...*/
    ...
    public PurchaseRequisition(PurchaseRequisitionDto purchaseRequisitionDto, Long productId, String userName, Boolean status , Users seller) {
        this.requestContent = purchaseRequisitionDto.getRequestContent();
